...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pcafeapp', '0013_lm_sandwitches_burgers'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('lm_sb_id', models.AutoField(serialize=False, primary_key=True)),
                ('sub_cat_id', models.IntegerField()),
                ('sb_name', models.CharField(max_length=50, null=True, blank=True)),
